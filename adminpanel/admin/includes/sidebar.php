...
<li>
    <a href="home.php?page=ranking-exam">
        ...
        <button type="button" class="btn btn-warning"> STUDENT RANKING BY EXAM</button>
        ...
        <li class="app-sidebar__heading"class="btn btn-dark">RESULT</li>
<li>
    <a href="okay/index1.php">
        <i class="metismenu-icon pe-7s-cup">
        </i>
        <button type="button" class="btn btn-danger"> STUDENT RESULT</button>
...
<!--  
<li class="app-sidebar__heading"class="btn btn-dark"></li>
<li>
    
    <a href="home2.php"><button type="button" class="btn btn-danger">STUDENT RESULT LOGIN</button></a><br><br>
        <i class="metismenu-icon pe-7s-cup">
        </i>
        <button type="button" class="btn btn-info"> Student Result login</button>
