        ...
        <div class="app-main__inner">
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    ...
                    <button type="button" class="btn btn-outline-light">EXAM MANAGEMENT !!</button> 
                        <!-- <div>MANAGE EXAM</div> -->
                    </div>
                </div>
            </div>        
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header"><button type="button" class="btn btn-success">EXAM LIST !!</button>
                    </div>
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            ...
                            <tr>
                                ...
                                <th class="text-left ">Exam Time Duration</th>  
