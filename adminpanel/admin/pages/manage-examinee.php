        ...
        <div class="app-main__inner">
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <button type="button" class="btn btn-outline-light">EXAM STUDENT MANAGEMENT !!</button>
                    </div>
                </div>
            </div>        
            ...
            <div class="col-md-12">
                ...
                <div class="card-header"> 
                    ...
                    <button type="button" class="btn btn-warning">EXAM STUDENT LIST !! </button>
                    <button type="button" class="btn btn-primary" style="margin-left:20px" onclick="window.location.href='pages/student-add.php' ">Add Students !! </button>

                
                </div>
                     <!-- <div class="card-header"> <button type="button" class="btn btn-primary">EXAM STUDENT LIST !!</button>  -->
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            <thead>
                            <tr>
                                <th>Student Full Name and Roll No.</th>
                                <th>Gender</th>
                                <th>Birthdate</th>
                                <th>Course Name</th>
                                ...
                                if($selExmne->rowCount() > 0)
                                {
                                    while ($selExmneRow = $selExmne->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                           ...
                                           <td>
                                               <a rel="facebox" href="facebox_modal/updateExaminee.php?id=<?php echo $selExmneRow['exmne_id']; ?>" 
