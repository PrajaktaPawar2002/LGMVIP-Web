 ...
 <div class="col-sm-9 mt-5">
    <div class ="row mx-5 text-center">
        <div class="col-sm-4 mt-5">
            ...
            <div class="card-header">MOBILE APPLICATION DEVELOPMENT</div>
            <div class="card-body">
                <h4 class="card-title">
                TYFS 2020 GPM
            </h4>
        ...
        <div class="col-sm-4 mt-5">
            ...
            style="max-width: 18rem;">
            <div class="card-header">ADVANCED DATABASE TECHNOLOGY</div>
            <div class="card-body">
                <h4 class="card-title">
                TYFS 2020 GPM
</h4>
...
<div class="col-sm-4 mt-5">
            ...
            style="max-width: 18rem;">
            <div class="card-header">WEB APPLICATION DEVELOPMENT</div>
            <div class="card-body">
                <h4 class="card-title">
                    TYFS 2020 GPM
</h4>
...
<div class="col-sm-4 mt-5">
            ...
            style="max-width: 18rem;">
            <div class="card-header">OPEN SOURCE TECHNOLOGY</div>
            <div class="card-body">
                <h4 class="card-title">
                TYFS 2020 GPM
</h4>
...
<div id="page-wrapper">
             ...
             <p class="lead" style="text-align: center;">Welcome To Online Examination system, <span >Governement Polytechnic Mumbai !!</span></p>
